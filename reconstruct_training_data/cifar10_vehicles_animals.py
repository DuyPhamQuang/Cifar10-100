...
def get_dataloader(datadir, data_amount, input_dim, num_classes, output_dim, device):
    print('TRAINSET BALANCED')
    data_loader = load_cifar10(root=datadir, batch_size=100, train=True, shuffle=False, start=0, end=50000)
    x0, y0 = get_balanced_data(data_loader, data_amount)
    ...
    x0, y0 = move_to_type_device(x0, y0, device)
